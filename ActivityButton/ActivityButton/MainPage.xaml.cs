    ...
    public partial class MainPage : ReactiveContentPage<MainViewModel>
    {
        ...
        protected void SetupReactiveBindings()
        {
            this.WhenActivated(disposables =>
            {
                ...
                this.OneWayBind(ViewModel, vm => vm.IsLoading, page => page.LoginControl.ActivityIndicator.IsRunning)
                    .DisposeWith(SubscriptionDisposables);

                this.OneWayBind(ViewModel, vm => vm.IsLoading, page => page.LoginControl.ActivityIndicator.IsVisible)
                    .DisposeWith(SubscriptionDisposables);

                //this.BindCommand(ViewModel, vm => vm.Login, page => page.loginControl.Command)
                //    .DisposeWith(SubscriptionDisposables);
            });
        }
    }
